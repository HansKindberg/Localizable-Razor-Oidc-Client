...
{
	public class UiCultureRouteConstraintTest
	{
		#region Fields
		...
		public async Task Match_Test()
		{
			...
			var uiCultureRouteConstraint = new UiCultureRouteConstraint(_requestLocalizationOptionsMonitor);

			Assert.False(uiCultureRouteConstraint.Match(null, null, "Test", [], RouteDirection.IncomingRequest));
			Assert.False(uiCultureRouteConstraint.Match(null, null, RouteKeys.Culture, [], RouteDirection.IncomingRequest));
			Assert.False(uiCultureRouteConstraint.Match(null, null, RouteKeys.UiCulture, [], RouteDirection.IncomingRequest));
			...
			Assert.False(uiCultureRouteConstraint.Match(null, null, RouteKeys.Culture, values, RouteDirection.IncomingRequest));
			Assert.True(uiCultureRouteConstraint.Match(null, null, RouteKeys.UiCulture, values, RouteDirection.IncomingRequest));
		}
